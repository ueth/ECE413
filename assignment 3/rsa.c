...
void encrypt(char *input_path, char *output_path, char *key_path){
    ...
    FILE *input_file = (*original_fopen)(input_path, "r");
    FILE *key_file = (*original_fopen)(key_path, "r");
    FILE *output_file = (*original_fopen)(output_path, "w");
    ...
    for(size_t i=0; i<counter; i++){
        ...
        (*original_fwrite)(" ", sizeof(char), sizeof(char), output_file);
    }
...
void decrypt(char *input_path, char *output_path, char *key_path){
    ...
    char export_ch;
    int encrypted_words[65536], n_num = 0, e_num = 0;
